...
ExclusivePopupManager =
{
    ...
    Lock = function( self, pContext:table, priority:number, kParameters:table )		
        -- Still keep basic error checking
        ...
        -- Store context and priority but don't lock the event
        self.m_pContext = pContext;
        self.m_priority = priority or PopupPriority.Current;
        
        -- Skip getting event ID from engine
        self.m_eventID = 1; -- Use dummy value to indicate "locked" state
        ...
        -- Queue the popup without pushing input context
